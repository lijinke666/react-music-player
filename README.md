...
| emptyLyricText    | `string`                                                                            | `-`                                                                                         | audio lyric empty lyric placeholder                                                                                                                                                                                                                                                                                                                         |
...
| onAudioLoadError         | `function(errMsg,currentPlayId, audioLists, audioInfo)`                             | `-`                                                                                         | audio load failed error handle                                                                                                                                                                                                                                                                                                                              |
